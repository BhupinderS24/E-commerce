...
/**
 * This class holds the details about Z2B which is a member variable of class {@link CompanyInfoModel} and stored on MongoDB.
 * 
 * @author bhupinder
 *
 */
public class Z2B {
	...
	public void setKEY_1(String key1) {
		this.KEY_1 = key1;
	}
